...
class UtilsMethods {
  ...
  static Species getSpeciesFromName (String name) {
    Species species;
    switch (name) {
      case UtilsValues.NOM_ESPECE_CASTAGNOLE :
        ...
        break;
      case UtilsValues.NOM_ESPECE_MEDUSE_A_POIS :
        ...
        break;
      case UtilsValues.NOM_ESPECE_MEDUSE_ATLANTIQUE :
        species = new Species("Méduse de l’Atlantique", "Chrysaora quinqueccirha", "meduse_atlantique.jpg", "?", "Cette espèce pose de réels problèmes sur les côtes américaines. Sa piqure peut être extrêmement douloureuse.", "Atlantique-est et Méditerranée.", "10 - 12 cm", "env. 5 ans");
        break;
      case UtilsValues.NOM_ESPECE_METYNNIS_TACHETE :
        ...
        break;
      case UtilsValues.NOM_ESPECE_OSCAR :
        ...
        break;
      case UtilsValues.NOM_ESPECE_PACU_NOIR :
      ...
      default :
        species = new Species("Espece inconnue", "Veuillez réesayer, ou contemplez ce magnifique pacu noir", "pacu_noir.jpg", " ", " ", " ", " ", " ", );
        break;
    }
    return species;
  }
